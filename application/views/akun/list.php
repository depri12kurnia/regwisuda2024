<div class="row">
	<div class="col-md-7">
		...
		<p class="text-center">
			<img src="<?php if ($user->gambar == "") {
							...
							echo base_url('assets/upload/user/' . $user->gambar);
						} ?>" style="max-width: 150px; height: auto;" class="img img-circle img-thumbnail">
		</p>

		<?php echo form_open_multipart(base_url('akun'), 'id="tambah"') ?>

		<div class="form-group row">
			<label class="col-sm-3 control-label text-left">Nama Lengkap <span class="text-danger">*</span></label>
			<div class="col-sm-9">
		...
		<div class="form-group row">
			<label class="col-sm-3 control-label text-left">Email <span class="text-danger">*</span></label>
			<div class="col-sm-9">
		...
		<div class="form-group row">
			<label class="col-sm-3 control-label text-left">Username <span class="text-danger">*</span></label>
			<div class="col-sm-9">
		...
		<div class="form-group row">
			<label class="col-sm-3 control-label text-left">Upload Foto</label>
			<div class="col-sm-9">
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<div class="form-group btn-group text-left">
					...
					<a href="<?php echo base_url('dasbor') ?>" class="btn btn-secondary btn-md" data-dismiss="modal"><i class="fa fa-times"></i> Kembali</a>
				</div>
			</div>
		</div>
	...
	<div class="col-md-5">
		...
		<?php echo form_open_multipart(base_url('akun/password'), 'id="tambah"') ?>

		<div class="form-group row">
			<label class="col-sm-4 control-label text-left">Password baru <span class="text-danger">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group row">
			<label class="col-sm-4 control-label text-left">Konfirmasi Password <span class="text-danger">*</span></label>
			<div class="col-sm-8">
