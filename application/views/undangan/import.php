<div class="card">
    ...
    <div class="card-body">
        ...
        ?>
        <form id="form-upload-user" method="post" action="<?php echo base_url('undangan/import_spreadsheet'); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-sm waves-effect waves-light" id="btnUpload">Upload Data</button>
            </div>
        </form>
    </div>
</div>